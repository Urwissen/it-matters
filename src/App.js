...
function App() {
  ...
  return (
    <div className="App">
      ...
      <h2>Facts From The Black History</h2>
      ...
      <footer>
        <aside onClick={() => window.open("https://github.com/Urwissen", "_blank")}>Visit me on {gitHubLogo}</aside>
        <aside onClick={() => window.open("https://www.blackhistoryapi.io/", "_blank")}>Contribute - blackhistoryapi.io</aside>
      </footer>
    </div>
  );
}
